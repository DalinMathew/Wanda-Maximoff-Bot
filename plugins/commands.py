...
async def repo_(client, message):
    ...
    await message.reply("<b>Deploy Your Own bot by Watching Tutorial :- https://youtu.be/APT1SyodJt0 </b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
